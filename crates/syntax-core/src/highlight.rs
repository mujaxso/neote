...
pub fn map_capture_name(name: &str) -> Highlight {
    match name {
        ...
        "link.bracket" => Highlight::Operator,
        "link.paren" => Highlight::Operator,
        "image" => Highlight::Variable,
        "image.description" => Highlight::Variable,
        "image.marker" => Highlight::Operator,
        "html_tag" => Highlight::Attribute,
        "html.tag" => Highlight::Attribute,
        "html.tag.name" => Highlight::Type,
        "html.attribute" => Highlight::Property,
        "html.attribute.name" => Highlight::Property,
        "html.attribute.value" => Highlight::String,
        "html.comment" => Highlight::Comment,
        "hard_line_break" => Highlight::Operator,
        "line_break" => Highlight::Operator,
        "line_break.soft" => Highlight::Operator,
        "strikethrough" => Highlight::Comment,
        "strikethrough.marker" => Highlight::Operator,
        "uri_autolink" => Highlight::String,
        "email_autolink" => Highlight::String,
        "backslash_escape" => Highlight::String,
        "escape" => Highlight::String,
        "latex" => Highlight::Constant,
        "latex.delimiter" => Highlight::Operator,
        "text" => Highlight::Plain,
        "number" => Highlight::Number,
        "whitespace" => Highlight::Plain,
