fn main() {
    ...
    // Static linking for Rust and TOML is enabled via syntax‑core features.
    // No need to download external grammar libraries.
    println!("cargo:warning=Using static tree‑sitter grammars for Rust and TOML.");
}
